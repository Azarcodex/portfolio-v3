...
import { Github, Linkedin, Mail, Code2, ArrowUpRight, Heart, Sparkles } from 'lucide-react';
import profileImg from '../assets/profileAzar.JPG';

const Footer = () => {
    const socialLinks = [
        { icon: <Github size={20} />, url: "https://github.com/Azarcodex", label: "GitHub" },
        { icon: <Linkedin size={20} />, url: "https://linkedin.com/in/mohammed-azarin-v-p-0571bb239", label: "LinkedIn" },
        { icon: <Code2 size={20} />, url: "https://leetcode.com/u/vpazar2799/", label: "LeetCode" },
        { icon: <Mail size={20} />, url: "mailto:vpazar2799@gmail.com", label: "Email" }
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-black text-slate-900 dark:text-white tracking-tighter uppercase italic">Azarin.</h3>
                                <p className="text-xs font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-[0.2em]">Build the future.</p>
                            </div>
                        </div>

                        <p className="text-lg text-slate-600 dark:text-slate-400 max-w-md leading-relaxed">
                            Crafting high-performance web architectures and AI-driven solutions with precision and passion.
                        </p>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="relative group p-8 rounded-3xl bg-linear-to-br from-indigo-600 to-purple-700 text-white shadow-2xl shadow-indigo-500/20 overflow-hidden"
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            <div className="space-y-2">
                                ...
                                <h4 className="text-3xl font-black tracking-tighter italic">HAVE A PROJECT IN MIND?</h4>
                                <p className="text-indigo-100 font-medium opacity-80">Let's turn your ideas into digital reality.</p>
                            </div>
                ...
                <div className="border-t border-slate-200 dark:border-slate-800/50 pt-8 flex flex-col md:flex-row justify-center items-center gap-6 text-sm text-slate-500 dark:text-slate-500 font-medium">
                    <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                        ...
                        <span className="flex items-center gap-1.5 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                            Engineered with <Heart size={14} className="text-red-500 fill-red-500 animate-pulse" /> and <Code2 size={14} />
                        </span>
                    </div>
                </div>
            </div>
