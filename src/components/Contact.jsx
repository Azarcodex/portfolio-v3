              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-slate-800/50 dark:bg-slate-900/50 border border-slate-300/20 dark:border-slate-700/50 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none transition-all text-sm font-medium text-slate-800 dark:text-white placeholder:text-slate-500"
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    required
                    rows="4"
                    className="w-full px-4 py-3 bg-slate-800/50 dark:bg-slate-900/50 border border-slate-300/20 dark:border-slate-700/50 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none transition-all text-sm font-medium text-slate-800 dark:text-white resize-none placeholder:text-slate-500"
              ...
              <AnimatePresence>
                {status === "success" && (
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-500 font-medium">
                      Your request has been safely logged.
                    </p>
                    <button
                      onClick={() => setStatus("idle")}
                      className="mt-6 px-6 py-2 border-2 border-indigo-600 text-indigo-600 rounded-full text-[10px] font-black uppercase hover:bg-indigo-600 hover:text-white transition-all tracking-widest"
                    >
                      New Session
                    </button>
                  </motion.div>
                ...
                {status === "error" && (
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-500 font-medium">
                      Please re-verify your network protocol.
                    </p>
                    <button
                      onClick={() => setStatus("idle")}
                      className="mt-6 px-6 py-2 border-2 border-rose-600 text-rose-600 rounded-full text-[10px] font-black uppercase hover:bg-rose-600 hover:text-white transition-all tracking-widest"
                    >
                      Retry Session
                    </button>
                  </motion.div>
